...
class ScoreModel:
    def __init__(self, initial_games=1000, test_games=1000, goal_steps=2000, lr=1e-2, file='scoreSave.npz'):
    ...
    def initial_population(self):
        ...
        print('Finished generating observation + action -> score training data')
